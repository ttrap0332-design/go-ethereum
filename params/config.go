...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		WalletIntegrationAddress: common.HexToAddress("0x25cA4F45fAFfb5e4D4EcF7687b4eBb6380D983c8"),
...
type ChainConfig struct {
	...
	WalletIntegrationAddress common.Address `json:"walletIntegrationAddress,omitempty"`
...
func (c *ChainConfig) ActiveSystemContracts(time uint64) map[string]common.Address {
	...
	if fork >= forks.Prague {
		...
		active["WALLET_INTEGRATION_ADDRESS"] = c.WalletIntegrationAddress
